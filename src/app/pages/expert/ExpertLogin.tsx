...
export default function ExpertLogin() {
  ...
  const [email, setEmail] = useState('sarah.williams@lincolnelementary.edu');
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 glass-card rounded-xl">
          <div className="text-center mb-8">
            ...
            <h2 className="text-lg text-text-label">Behavioral Expert Portal</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <Input
                id="email"
                type="text"
                placeholder="sarah.williams@lincolnelementary.edu"
                value={email}
